...
;; ;; Changing a bit the colors of the powerline
;; (custom-set-faces
...
;; Powerline theme taken here: https://github.com/howardabrams/dot-files/blob/master/emacs-mode-line.org
...
(defun powerline-simpler-minor-display (s)
    (replace-regexp-in-string
     (concat " " (mapconcat 'identity '("񓵸" "Helm" "FlyC*" "Projectile" "Fill" "BufFace" "Pre" "SP/s" "ws") "\\|")) "" s))
